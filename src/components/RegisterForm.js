...
class RegisterForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {termsAccepted: false, gender: 'Male', country: 'Tunisia'};
        ...
        <div className="mx-auto m-4">
          ...
          <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                <Field name="identifier" label="Identifier (CIN ...)" type="password" component={renderField} />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                <Field name="gsm" label="Phone Number" type="tel" component={renderField} />
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                <Field name="address" label="Current Address" type="address" component={renderField} />
              </div>
              <div class="form-group col-md-6">
            ...
            <div class="col-md-12 text-center">
              <button type="submit" class="btn btn-primary" disabled={submitting || !this.state.termsAccepted} >Submit</button>
            </div>
          </form>
      </div>
    )
