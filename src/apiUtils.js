export const parseApiErrors = (error) => {
  ...
  const canWriteAppointmentRoles = ['ROLE_WRITER', 'ROLE_ADMIN', 'ROLE_SUPERADMIN'];
  
  export const canWriteAppointment = (userData) => {
    return null !== userData
      && userData.roles.some(
        userRoles => canWriteAppointmentRoles.includes(userRoles)
      );
  };